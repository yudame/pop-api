...
# https://auth0.com/docs/quickstart/backend/django#configure-auth0-apis
...
def jwt_decode_token(token):
    ...
    jwks = requests.get(f'https://{ HOSTNAME }/.well-known/jwks.json').json()
    public_key = None
    ...
    return jwt.decode(token, public_key, audience=APP_NAME, issuer=issuer, algorithms=['RS256'])
